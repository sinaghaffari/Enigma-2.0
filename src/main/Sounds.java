...
public class Sounds { //not currently used
	...
	public static void initalize() {
		...
		nameVal.put("Walther P99", Integer.valueOf(0)); valName.put(Integer.valueOf(0), "Walther P99");
		nameVal.put("Colt M16A4", Integer.valueOf(1)); valName.put(Integer.valueOf(1), "Walther P99");
		nameVal.put("H&K MP5",Integer.valueOf(2)); valName.put(Integer.valueOf(2), "H&K MP5");
		
		buffer = BufferUtils.createIntBuffer(NUM_SOUNDS);
		source = BufferUtils.createIntBuffer(NUM_SOUNDS);
		sourcePos = (FloatBuffer)BufferUtils.createFloatBuffer(3*NUM_SOUNDS);
		sourceVel = (FloatBuffer)BufferUtils.createFloatBuffer(3*NUM_SOUNDS);
